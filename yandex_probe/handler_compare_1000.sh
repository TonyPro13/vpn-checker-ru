...
echo "batch1000: starting Mihomo RU test" >&2
echo "batch1000: meta=$(printf '%s' "$META" | jq -c 'del(.sample_source_indexes)')" >&2
echo "batch1000: binary=$(ls -l "$MIHOMO_BIN" 2>&1)" >&2
